...
As you can see, the policies of Margaret Thatcher made unemployment lower by a lot, but inflation boosted up inversly. That is the result of Keynesianist policies Thatcher implemented. (But this discussion is not part of this project. Since this is a LabBook, I thought it is nice to bring such things up).
...
As you can see, the UK until 2016 hasn't yet recovered from the 2008 crisis.
...
uk_dataxl_tidy %>%
  ...
  geom_line(aes(y = `Real GDP of England at market prices`, colour="GDP of England")) +
